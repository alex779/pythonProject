...
def key_warn():
    ...
    BODY_TEXT = \
        ("Your IAM Access Key for 472345033518 (Inveniam) AWS account is expiring in a few days and will be deactivated.\r\n"
         "Log into AWS and go to your IAM user to rotate API key:"
         " https://console.aws.amazon.com/iam/home?#security_credential")
    BODY_HTML = """
                        Your IAM Access Key need to be rotated in AWS Account: 472345033518 (Inveniam) AWS account as it is expiring soon. 
                        Log into AWS and go to your https://console.aws.amazon.com/iam/home?#security_credential 
                        to create a new set of keys as decribed here - https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html#Using_RotateAccessKey. 
...
def key_deactivate():
    ...
    SUBJECT = "IAM Access Key Rotation"
    BODY_TEXT = \
        ("Your IAM Access Key for 472345033518 (Inveniam) AWS account is expired and has been deactivated.\r\n"
         "Log into AWS and go to your IAM user to rotate API key or re-activate it:"
         " https://console.aws.amazon.com/iam/home?#security_credential")
    BODY_HTML = """
                        Your IAM Access Key need to be rotated in AWS Account: 472345033518 (Inveniam) AWS account as it has expired. 
                        Log into AWS and go to your https://console.aws.amazon.com/iam/home?#security_credential 
                        to create a new set of keys or re-activate the old one. 
                        More details - https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html#Using_RotateAccessKey
                        Ensure to disable / remove your previous key pair in case a new pair is generated.
                                    """
    CHARSET = "UTF-8"
    client = boto3.client('ses', region_name=AWS_REGION)
